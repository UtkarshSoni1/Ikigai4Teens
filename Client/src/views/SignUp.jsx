  ...
  return (
    ...
    <div className='absolute inset-0 h-screen w-full flex items-center justify-center'>
      ...
      <div className='h-[90%] w-4/5 rounded-4xl border-2 border-white flex items-center z-20 overflow-hidden'>
        <div className='h-full w-[40%] border-r-2 border-white bg-blue-400/60 '>
          <p className=' font-semibold text-center mt-8 text-3xl text-black '>SignUp</p>     
          <form className='h-full w-full flex flex-col items-center text-black font-semibold' onSubmit={submitHandler}>
              <div className='h-1/8 w-4/5 mt-10'>
                <p className=' text-lg text-left mb-2'>Enter your Name</p>
                <input type="text" name="name" id="" placeholder='John doe' className='h-2/3 w-full border-2 border-zinc-900  rounded-2xl outline-none placeholder-white/60 text-2xl text-center' 
                onChange={(e)=>{setname(e.target.value)}} />
              </div>
              <div className='h-1/8 w-4/5 mt-10'>
                <p className=' text-lg text-left mb-2'>Enter your Email</p>
                <input type="text" name="email" id="" placeholder='m@example.com' className='h-2/3 w-full border-2 border-zinc-900 rounded-2xl outline-none placeholder-white/60 text-2xl text-center' 
                onChange={(e)=>{setemail(e.target.value)}}/>
              </div>
              <div className='h-1/8 w-4/5 mt-10'>
                <p className=' text-lg text-left mb-2'>Enter your Password</p>
                <input type="password" name="password" id="" placeholder='*********' className='h-2/3 w-full border-2 border-zinc-900 rounded-2xl outline-none placeholder-white/60 text-2xl text-center' 
                onChange={(e)=>{setpassword(e.target.value)}}/>
              </div>
              <div className='h-1/8 w-4/5 mt-10 mb-10'>
                <p className=' text-lg text-left mb-2'>confirm your password</p>
                <input type="password" name="passwordC" id="" placeholder='confirm your password' className='h-2/3 w-full border-2 border-zinc-900 rounded-2xl outline-none placeholder-white/60 text-2xl text-center' 
